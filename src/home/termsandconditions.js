            ...
            <section className="header1 mb-100">
                <div className="home-banner">
                    <Container>
                        ...
                        <Row>
                            <Col md={12}>
                                <h1 className='w-100 text-center my-5'>TERMS & CONDITIONS</h1>
                                <Card className="mb-5 p-4 ">
                                    <CardBody>
                                        ...
                                        <h6 className='my-5'>2. Authorized Use</h6>
                                        <ol>
                                        ...
                                        <h6 className='my-5'>IV.  User Submitted Information</h6>
                                        <ol>
                                            ...
                                            <li>In case you want to report abuse with respect to User Submitted Information, please write to <a href="SIP@inqui-lab.org" target="_black">info@inqui-lab.org.</a></li>
    
                                        </ol>
                                        <h6 className='my-5'>V. Changes to the Site </h6>
                                        ...
                                        <h6 className='my-5'>VI. Third-Party Content</h6>
                                        ...
                                        <h6 className='my-5'>VII. Links to Third-Party Websites</h6>
                                        ...
                                        <h6 className='my-5'>VIII. Social Media Pages</h6>
                                        ...
                                        <h6 className='my-5'>IX. User Disagreements</h6>
                                        ...
                                        <h6 className='my-5'>X. Confidential Information</h6>
                                        ...
                                        <h6 className='my-5'>XI. Termination</h6>
                                        ...
                                        <h6 className='my-5'>XII. Disclaimer of Warranty</h6>
                                        ...
                                        <h6 className='my-5'>XIII. Limitation of Liability</h6>
                                        ...
                                        <h6 className='my-5'>XV. Applicable Laws</h6>
                                ...
                                <h2 className='text-center w-100 my-5'>PRIVACY POLICY</h2>
                                <Card className='mb-5 p-4 '>
...
“Personal information”, is any information that enables us to identify you, directly or indirectly, by reference to an identifier such as your name, identification number, location data, online identifier or one or more factors specific to you. Personal information includes “sensitive personal information” and “pseudonymised personal information” but excludes anonymous information or information that has had the identity of an individual permanently removed.
                                        ...
                                        <h6 className='my-5'>1. Information We Collect and How We Use It
                                        </h6>
                                        ...
                                        <p>1.4. The SIPP gathers and retains Personal Information about you, including name, email address, phySIPal address, phone number, or any  other personal or background information when you voluntarily submit it to us.</p>
                                        ...
                                        <h6 className='my-5'>2. Social Networking Activities</h6>
                                        ...
                                        <h6 className='my-5'>3. Site Use Information</h6>
                                        ...
                                        <h6 className='my-5'>4. Collection and Monitoring of Information
                                        </h6>
                                        ...
                                        <h6 className='my-5'>5. How We Use the Information</h6>
                                        ...
                                        <h6 className='my-5'>7. Disclosing Information to Third Parties</h6>
                                        ...
                                        <h6 className='my-auto'>9. Links to Other Websites</h6>
                                        ...
                                        <h6 className='my-5'>10. Child Privacy</h6>
                                        ...
                                        <p>If you have any questions or complaints regarding our Privacy Policy or our Site, please contact us at <a href='https://www.inquilabfoundation.org/' > info@inqui-lab.org</a></p>
